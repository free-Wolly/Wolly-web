...
const Blog = ({ messages }: any): JSX.Element => {
  return (
    <div
      id="blog"
      className="container mx-auto 2xl:px-20 xl:px-16 lg:px-16 md:px-8 sm:px-4 px-4"
    >
      <SectionHeader
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16 mb-16">
        <div className="relative w-full xl:w-[55%] lg:w-[50%] flex flex-col rounded-3xl p-6 lg:p-0 lg:pt-0">
          ...
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <div className="text-[22px] text-[#597F9DBF] text-center font-[BOG] tracking-tighter">
