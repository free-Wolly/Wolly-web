    ...
    <div id="about" className="container mx-auto 2xl:px-32 xl:px-16 lg:px-16 md:px-8 sm:px-4 px-4">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16 mb-16">
        ...
        <div className="flex flex-col items-center w-full lg:w-2/6 pt-12">
          <div className="text-center text-[30px] font-bold font-[GEOCAPS] text-[#304D63] pb-8 ">დივნის ალაგება</div>
          <div className="text-[23px] font-[BOG] text-[#304D63] text-center">
            ლორემ იპსუმ დივნის ალაგება ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ დივნის ალაგება
            ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ ლორემ იპსუმ დივნის ალაგება
          </div>
        </div>
      </div>
    </div>
