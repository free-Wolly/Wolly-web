...
import { checkIfExists, ifNoDataRedirect } from "../../helpers/functions";
...
export default function FinishOrder() {
  ...
  const createSimpleOrderVariables = {
    data: {
      ...
      addressId,
      chemicalCleaning: {
        twoSeaterSofa: checkIfExists(data.twoSeaterSofa),
        threeSeaterSofa: checkIfExists(data.threeSeaterSofa),
        softChair: checkIfExists(data.softChair),
        sixSeaterSofa: checkIfExists(data.sixSeaterSofa),
        mattress: checkIfExists(data.mattress),
        fourSeaterSofa: checkIfExists(data.fourSeaterSofa),
        fiveSeaterSofa: checkIfExists(data.fiveSeaterSofa),
        carpet: checkIfExists(data.carpet),
        armchair: checkIfExists(data.armchair),
      },
    },
  };
